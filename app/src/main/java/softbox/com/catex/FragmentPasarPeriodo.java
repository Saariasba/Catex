...
public class FragmentPasarPeriodo extends Fragment {

    View vista;
    Button cancelar;
    ImageButton pasar;
    FragmentPasarPeriodo f = this;
    Long idP = Inicio.idP;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        vista = inflater.inflate(R.layout.fragment_pasar_periodo,container,false);
